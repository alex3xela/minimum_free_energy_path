...
... MOVINGRESTRAINT
PRINT ARG=rmsd_1,rmsd_2 FILE=colvar STRIDE=50 FMT=%8.4f'''.format(entity0, KAPPA_rmsd1,KAPPA_rmsd2,KAPPA_rmsd1,float(KAPPA_rmsd2)/2,KAPPA_rmsd1,float(KAPPA_rmsd2)/5))
